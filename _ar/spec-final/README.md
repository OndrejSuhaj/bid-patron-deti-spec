...
```
_ar/spec-final/
  BA/                      # Business Analysis tier (158 dokumentů)
    EN/    (32)  entity domény
    UC/    (22)  případy užití
  ...
  UX/                      # UX tier — rezervováno (prázdné registry; doplní UX rekonstrukce)
    IA/  WIRE/  COMP/  COPY/
  final-publication-map.md     # 158 řádků: finální soubor ← zdrojový draft, tier, vrstva
