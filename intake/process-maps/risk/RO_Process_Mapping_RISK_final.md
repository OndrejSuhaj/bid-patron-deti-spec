...
Field | Fill In | Ro
Process Name | Risk management | Risk management
Country / Team | CZ | Ro
Process Owner | Daniela Bruková Risk manager | Iuliana Jitaru Risk analist
Date | 2026-02-11 00:00:00 | 2026-04-07 00:00:00
Process Goal (What is the output?) | Create a clear and comprehensive process documentation for the risk management a… | documenting the steps leading to the approval or rejection of the request, highl…
Process Start (What triggers it?) | Risk manager ( in case of NO low risk ) or COO-front  ( in case of low risk ) ta… | after verifications made by the coordinator and determination of the gift by the…
Process End (When is it finished?) | Risk manager ( in case of NO low risk ) or COO- front ( in case of low risk ) ma… | After analyzing the applicant, the guarantor and the gift, it is determined whet…
...
Coordinator - front ( COO- front )
AFFIL manager

### SHEET: 3 Proces Steps Ro  (29 řádků)
Step Process Number | Role Responsible |  | Step Description (Start with a verb) | ro Step Description (Start with a verb) | Differences | Manual / Automated | Ro Manual / Automated | System Used (if any) | ro System Used (if any) | Status | Ro Status | Notifikace email ZZ | RO Notifikace email ZZ | Notifikace email Patron | RO Notifikace email Patron | STATUS IN PARENT ZONE | RO STATUS IN PARENT ZONE | STATUS IN PATRON ZONE | RO STATUS IN PATRON ZONE
 | ✅ vyberu z listu ROLE | Fáze | ✅ Napíši aktivní sloveso - používejte přítomný čas, 3. osoba jednotného čísla | ✅ Napíši aktivní sloveso - používejte přítomný čas, 3. osoba jednotného čísla |  |  |  | ✅ Napíši jaký systém je použit, nebo píšu Bez systému. Políčko nenechávám prázdn… | ✅ Napíši jaký systém je použit, nebo píšu Bez systému. Políčko nenechávám prázdn…
1A | Risk manager | LOW RISK | Sets the Low Risk criteria – scoring system | we don't have this step | takes every request regardless of the gift value or request history | manually | – | žádost na IT | – | NA | – | ne | – | ne | – | ne | – | ne | –
1B | Risk manager |  | Sets the Low Risk criteria – price level in the Scoring Risks Card | we don't have this step | takes every request regardless of the gift value or request history | manually | – | BE | – | NA | – | ne | – | ne | – | ne | – | ne | –
1C | IT systém |  | Evaluates the Low Risk scoring | we don't have this step | takes every request regardless of the gift value or request history | automated | – | BE | – | NA | – | ne | – | ne | – | ne | – | ne | –
1D | Coordinator front ( must be in position more than 6 months ) |  | Checks the Low Risk criteria and verifies whether it can be approved automatical… | we don't have this step | takes every request regardless of the gift value or request history | manually | – | BE | – | Zpracování žádosti | – | ne | – | ne | – | ano | – | ano | –
1EA | Coordinator front |  | Approves the Application | we don't have this step | takes every request regardless of the gift value or request history | manually | – | BE | – | Scoring OK | – | ne | – | ne | – | ano | – | ano | –
1EB | Coordinator front |  | Submits the Application to Risk Manager (if risk-related information identified … | we don't have this step | takes every request regardless of the gift value or request history | manually | – | BE | – | Scoring kontrola | – | ne | – | ne | – | ano | – | ano | –
2A | Risk manager | checking Parent | Checks the information and all the attached documents in the Application | I ensure that each information is correct and complete by checking the attached … | –– | manually | manually | BE | BE | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
2B | Risk manager |  | Checks the Black list | we don't have this step | –– | manually | –– | BE | –– | Scoring kontrola | Scoring | ne | –– | ne | –– | ano | –– | ano | ––
2C | Risk manager |  | Reviews previous findings of the Risk | check previous requests and notes left by either me/coordinator/acquisition spec… | –– | manually | manually | BE | BE | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
2D | Risk manager |  | Reviews previous Applications ( for example whether Feedback is completed ) | I check the type of gift previously requested and make sure it is not in uncoope… | –– | manually | manually | BE | BE | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
2E | Risk manager |  | PErforms external check (Google, social media, ChatGPT) | I make sure that the information received about the family and the need for the … | –– | manually | manually | Internet | Internet | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
2F | Risk manažer |  | Performs checks in Cribis and the Insolvency Register (enforcement and insolvenc… | we don't have this step | –– | manually | –– | Cribis, ISIR | –– | Scoring kontrola | Scoring | ne | – | ne | – | ano | – | ano | –
2G | Risk manager |  | Checks single-parent status | I am looking for information about both parents, checking if the family is singl… | I use just portal and marriage publications | manually | manually | CRM, Internet | CRM, Internet | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
3A | Risk manager | checking Patron | Checks Blacklistu | we don't have this step | I use the notes about the guarantor, I contact the guarantor for an initial disc… | manually | manually | BE | BE | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
3B | Risk manager |  | Reviews previous findings of the Risk | I follow the internal notes about the guarantor and discuss with the procurement… | –– | manually | manually | BE | BE | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
3C | Risk manager |  | Verifies the relationship between Patron and Parent | I make sure that the applicant and the grantee are not related, | –– | manually | manually | BE | BE | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
3D | Risk manager |  | Checks whether Patron is/is not as well the Supplier | if the guarantor is also a supplier I check the prices charged by other supplier… | –– | manulally | manulally | Cribis, Internet | Internet | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
3E | Risk manager |  | Prforms external check (Google, social media, ChatGPT) | I look for information about the guarantor on social networks and if the guarant… | –– | manually | manually | Internet | Internet | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
4 | Risk manager | checking Subject of help | Identifies the subject of help, compare value on the market etc. | I make sure that the requested gift meets the child's need, I also make sure tha… | –– | manually | manually | BE, Internet | BE, Internet | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
5A | Risk manager | checking Supplier | Performs internal check of the supplier | I talk to the procurement specialist and the social relations specialist to get … | –– | manually | manually | BE, Internet | BE, Internet | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
5B | Risk manager |  | Performs external verification of the supplier ( CRIBIS ETC ) | I compare the prices offered by the supplier for the same type of service, I mak… | –– | manually | manually | Cribis, Internet | Internet | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
6A | Risk manager | Adding missing information | Requests missing information from  either Parent, Patron, or supplier through co… | we don't have this step | I contact the guarantor if he/she did not provide sufficient information or ther… | manually | manually | BE, Internet | BE, Internet, phone | Scoring k doplnění | Scoring | ne | no | ne | no | ano | no | ano | no
6B | Coordinator front |  | Requests additional information from either Parent, Patron, or supplier | I follow up if the applicant has completed a new guarantor | I contact the/ garantor/ parent or  I talk with procurement specialist/ coordona… | manually | manually | BE, mail | BE, | Scoring k doplnění | returned_new_patron | ne | yes | ne | yes | ano | yes | ano | yes
6C | Coordinator front |  | Adds the information to the Application | we don't have this step | returning the request to the coordinator without scoring if the information is i… | manually | manually | BE | BE | Scoring kontrola | Scoring | ne | no | ne | no | ano | no | ano | no
7 | Affil manager | checking information | Verifies added information with Patron if necessary | we don't have this step | I contact the/ garantor/ parent or  I talk with procurement specialist/ coordona… | manually | manually | email/call | call | Scoring k doplnění | Scoring | ne | no | ne | no | ano | no | ano | no
8A | Risk manager | Evaluation | Approves the Application | send to marketing for story processing | –– | manually | manually | BE | BE | Scoring OK | in_progress | ne | yes | ne | yes | ano | yes | ano | yes
8B | Risk manager | Evaluation | Rejects the application | does not grant acceptance for the requested gift | –– | manually | manually | BE | BE | Scoring KO | Scoring KO | ano | yes | ano | yes | ano | yes | ano | yes
...
1C | IT systém |  | Evaluates the Low Risk scoring | automated | BE | NA | ne | ne | ne | ne
...
2F | Risk manažer |  | Performs checks in Cribis and the Insolvency Register (enforcement and insolvenc… | manually | Cribis, ISIR | Scoring kontrola | ne | ne | ano | ano
...
7 | Affil manager | checking information | Verifies added information with Patron if necessary | manually | email/call | Scoring k doplnění | ne | ne | ano | ano
...
Step Process Number | Role Responsible |  | Step Description (Start with a verb) | Manual / Automated | System Used (if any) | Status | Notifikace email ZZ | Notifikace email Patron | Zobrazení v zóně ZZ | Zobrazení v zóně Patrona
 | ✅ vyberu z listu ROLE | Fáze | ✅ Napíši aktivní sloveso - používejte přítomný čas, 3. osoba jednotného čísla |  | ✅ Napíši jaký systém je použit, nebo píšu Bez systému. Políčko nenechávám prázdn…
1A | Risk manažer | LOW RISK | Nastaví kritéria LowRisku - bodové hodnocení | manual | žádost na IT | NA | ne | ne | ne | ne
1B | Risk manažer |  | Nastaví kritéria LowRisku - cenová hladina na kartě Scoring Risks Form | manual | BE | NA | ne | ne | ne | ne
1C | IT systém |  | vyhodnotí Scoring LowRisk | automated | BE | NA | ne | ne | ne | ne
1D | Koordinátor ( musí být v roli více než 6M ) |  | Zkontroluje LowRisk a ověří jestli může automaticky schválit | manuálně | BE | Zpracování žádosti | ne | ne | ano | ano
1EA | Koordinátor |  | Žádost schválí | manuálně | BE | Scoring OK | ne | ne | ano | ano
1EB | Koordinátor |  | Žádost předá na Risk (pokud zjistí při zpracování žádosti rizikové informace) | manuálně | BE | Scoring kontrola | ne | ne | ano | ano
2A | Risk manažer | Prověření žadatele | Zkontroluje údaje  v žádosti  a přiložené doklady | manuálně | BE | Scoring kontrola | ne | ne | ano | ano
2B | Risk manažer |  | Zkontroluje stav Blacklistu | manuálně | BE | Scoring kontrola | ne | ne | ano | ano
2C | Risk manažer |  | Zkontroluje předchozí zjištění Risku | manuálně | BE | Scoring kontrola | ne | ne | ano | ano
2D | Risk manažer |  | Zkontroluje předchozí žádosti | manuálně | BE | Scoring kontrola | ne | ne | ano | ano
2E | Risk manažer |  | Provede externí ověření google, sociální sítě, chat GPT | manuálně | Internet | Scoring kontrola | ne | ne | ano | ano
2F | Risk manažer |  | Provede kontrolu v Cribisu, a Insolvenčním rejstříku ( exe a inso ) | manuálně | Cribis, ISIR | Scoring kontrola | ne | ne | ano | ano
2G | Risk manažer |  | Zkontroluje stav Samoživitel | manuálně | CRM, Internet | Scoring kontrola | ne | ne | ano | ano
3A | Risk manažer | Prověření patrona | Zkontroluje stav Blacklistu | manuálně | BE | Scoring kontrola | ne | ne | ano | ano
3B | Risk manažer |  | Zkontroluje předchozí zjištění Risku | manuálně | BE | Scoring kontrola | ne | ne | ano | ano
3C | Risk manažer |  | Ověří vztah patrona k žadateli | manuálně | BE | Scoring kontrola | ne | ne | ano | ano
3D | Risk manažer |  | Ověří zda Patron není tak dodavatel | manuálně | Cribis, externě | Scoring kontrola | ne | ne | ano | ano
3E | Risk manažer |  | Provede externí ověření google, sociální sítě | manuálně | Internet | Scoring kontrola | ne | ne | ano | ano
4 | Risk manažer | Kontrola daru | Identifikuje dar, ověří odůvodnění, ceny, rozsah daru | manuálně | BE, Internet | Scoring kontrola | ne | ne | ano | ano
5A | Risk manažer | Prověření dodavatele | Provede interní  ověření dodavatele | manuálně | BE, Internet | Scoring kontrola | ne | ne | ano | ano
5B | Risk manažer |  | Provede externí ověření dodavatele | manuálně | Cribis, Internet | Scoring kontrola | ne | ne | ano | ano
6A | Risk manažer | Doplnění informací | Vyžádá od koordinátora chybějící informace | manuálně | BE, Internet | Scoring k doplnění | ne | ne | ano | ano
6B | Koordinátor FRONT |  | Vyžádá od žadatele nebo patrona nebo dodavatele doplnění informací | manuálně | BE, mail | Scoring k doplnění | ne | ne | ano | ano
6C | Koordinátor FRONT |  | Informace doplní k žádosti | manuálně | BE | Scoring kontrola | ne | ne | ano | ano
7 | Affil manažer | Doplnění informací | Ověří informace u Patrona | manuálně | email/call | Scoring k doplnění | ne | ne | ano | ano
8A | Risk manažer | Vyhodnocení | Žádost schválí | manuálně | BE | Scoring OK | ne | ne | ano | ano
8B | Risk manažer | Vyhodnocení | Žádost zamítne | manuálně | BE | Scoring KO | ano | ano | ano | ano
