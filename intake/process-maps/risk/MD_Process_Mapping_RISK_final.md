...
Field | Fill In | MD
Process Name | Risk management | RISK
Country / Team | CZ | MD
Process Owner | Daniela Bruková Risk manager | Operational Manager
Date | 2026-02-11 00:00:00 | 2026-03-31 00:00:00
Process Goal (What is the output?) | Create a clear and comprehensive process documentation for the risk management a… | Evaluated leads with approved or rejected status based on risk assessment.
Process Start (What triggers it?) | Risk manager ( in case of NO low risk ) or COO-front  ( in case of low risk ) ta… | Lead is moved to “Score Check” status.
Process End (When is it finished?) | Risk manager ( in case of NO low risk ) or COO- front ( in case of low risk ) ma… | Lead is approved/rejected and status is updated with comments in the system.
...
Role Name | Description (optional) |  |  |  |  | MD
  ·
...
Supplier | A person or company that supplies and deliver services or goods that are subject… |  |  |  |  | Supplier
Coordinator - front ( COO- front ) |  |  |  |  |  | Coordinator
AFFIL manager

### SHEET: 3_Process_Steps ENG  (29 řádků)
Step Process Number | Role Responsible |  | MD | Step Description (Start with a verb) | MD | Manual / Automated | MD | System Used (if any) | MD | Status | MD | Notifikace email ZZ | Notifikace email Patron | STATUS IN PARENT ZONE | STATUS IN PATRON ZONE
...
1A | Risk manager | LOW RISK | Coordinator | Sets the Low Risk criteria – scoring system | Sets the low risk | manually | manually | žádost na IT | BE | NA | Score Check | ne | ne | ne | ne
...
1D | Coordinator front ( must be in position more than 6 months ) |  | Coordinator | Checks the Low Risk criteria and verifies whether it can be approved automatical… | Assess the lead’s eligibility for approval | manually | manually | BE | BE | Zpracování žádosti | Score Check | ne | ne | ano | ano
1EA | Coordinator front |  |  | Approves the Application | Approves the application | manually | manually | BE | BE | Scoring OK | Score Check | ne | ne | ano | ano
1EB | Coordinator front |  |  | Submits the Application to Risk Manager (if risk-related information identified … | Sends the application to the Risk Manager if any entities raise concerns | manually | manually | BE | BE | Scoring kontrola | Score Check | ne | ne | ano | ano
2A | Risk manager | checking Parent | Risk Manager | Checks the information and all the attached documents in the Application | Verifies the information and attached documents in the application | manually | manually | BE | BE | Scoring kontrola | Score Check | ne | ne | ano | ano
2B | Risk manager |  |  | Checks the Black list |  | manually |  | BE |  | Scoring kontrola |  | ne | ne | ano | ano
2C | Risk manager |  | Risk Manager | Reviews previous findings of the Risk | Reviews previous findings of the Risk | manually | manually | BE | BE | Scoring kontrola | Score Check | ne | ne | ano | ano
2D | Risk manager |  | Risk Manager | Reviews previous Applications ( for example whether Feedback is completed ) | Reviews previous Applications | manually | manually | BE | BE | Scoring kontrola | Score Check | ne | ne | ano | ano
2E | Risk manager |  | Risk Manager | PErforms external check (Google, social media, ChatGPT) | Performs external check | manually | manually | Internet | BE | Scoring kontrola | Score Check | ne | ne | ano | ano
2F | Risk manažer |  | Risk Manager | Performs checks in Cribis and the Insolvency Register (enforcement and insolvenc… | Performs checks in InfoDebit | manually | manually | Cribis, ISIR | InfoDebit informational system | Scoring kontrola | Score Check | ne | ne | ano | ano
2G | Risk manager |  | Risk Manager | Checks single-parent status | Checks single-parent status | manually | manually | CRM, Internet | BE | Scoring kontrola | Score Check | ne | ne | ano | ano
...
4 | Risk manager | checking Subject of help | Risk Manager | Identifies the subject of help, compare value on the market etc. | Determines the subject of assistance and benchmarks its market value | manually | manually | BE, Internet | Web | Scoring kontrola | Score Check | ne | ne | ano | ano
5A | Risk manager | checking Supplier | Risk Manager | Performs internal check of the supplier | Performs internal check of the supplier | manually | manually | BE, Internet | Web | Scoring kontrola | Score Check | ne | ne | ano | ano
5B | Risk manager |  | Risk Manager | Performs external verification of the supplier ( CRIBIS ETC ) | Performs external verification of the supplier | manually | manually | Cribis, Internet | Infodebit, web | Scoring kontrola | Score Check | ne | ne | ano | ano
6A | Risk manager | Adding missing information | Risk Manager | Requests missing information from  either Parent, Patron, or supplier through co… | Requests missing information from  either Parent or Patron | manually | manually | BE, Internet | BE | Scoring k doplnění | Score Check | ne | ne | ano | ano
6B | Coordinator front |  | Coordinator | Requests additional information from either Parent, Patron, or supplier | Requests additional information from either Parent or Patron | manually | manually | BE, mail | BE | Scoring k doplnění | Score Check | ne | ne | ano | ano
6C | Coordinator front |  | Coordinator | Adds the information to the Application | Adds the information to the application | manually | manually | BE | BE | Scoring kontrola | Score Check | ne | ne | ano | ano
7 | Affil manager | checking information |  | Verifies added information with Patron if necessary |  | manually |  | email/call |  | Scoring k doplnění | Score Check | ne | ne | ano | ano
8A | Risk manager | Evaluation | Risk Manager | Approves the Application | Approves the application | manually | manually | BE | BE | Scoring OK | Score OK | ne | ne | ano | ano
8B | Risk manager | Evaluation | Risk Manager | Rejects the application | Rejects the application | manually | manually | BE | BE | Scoring KO | Score KO | ano | ano | ano | ano
