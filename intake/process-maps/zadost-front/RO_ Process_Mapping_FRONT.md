...
Field | Fill In |  | Fill In
Process Name | APPLICATION - FRONT activities | Process Name | Coordinator, Acquisition specialist
Country / Team | CZ | Country / Team | RO
Process Owner | PAVLINA BRABCOVA - FRONT COORDINATOR | Process Owner | Roxana Stan, Teodora Popescu
Date | 2026-02-13 00:00:00 | Date | 2026-03-03 00:00:00
Process Goal (What is the output?) | MAPPING THE STEPS AND PROCESSES FROM RECEIPT OF THE APPLICATION TO SUBMISSION FO… | Process Goal (What is the output?) | Ensuring that all the information found in the request is correct and assessing …
Process Start (What triggers it?) | COMPLETELY FILLED OUT APPLICATION FROM THE PATRON AND APPLICANT (BOTH FORMS) | Process Start (What triggers it?) | The process starts with requests under the 'To Check' status.
Process End (When is it finished?) | APPLICATION IS SENT FOR PUBLICATION OF THE STORY | Process End (When is it finished?) | When the verification part of the request is completed and the donation amount i…
...
Role Name | Description (optional) | Role Name | Description (optional)
 |  | Parent | The person who initiates the child's request, specifying the need by mentioning …
 |  | Guarantor | The person or organization that supports the child and tries to help them by des…
parent | legal representative of the child | IT systém | Handles the technical processing of applications and the distribution of notific…
patron |  | Web | Offers the application form and provides access to the dedicated environment.
IT system | backend | Coordinator | Oversees administrative review of applications, tracks their completion status, …
notification | backend + mautic | Procurement Specialist | Plans and manages all procurement activities to ensure the foundation obtains th…
...
Step Process Number | Role Responsible | Role Responsible RO | Step Description (Start with a verb) | Step Description (Start with a verb) - RO | Differences | Manual / Automated | Manual/ Automated -RO | System Used (if any) | System Used ( if any) -RO | Status | Status -RO | Notification email ZZ | Notification email ZZ -RO | Notification email patron | Notification emai patron -RO | Parent zone notification | Parent zone notification- RO | Patron zone notification | Patron zone notification-RO
  ·
 | ✅ vyberu z listu ROLE |  | ✅ Napíši aktivní sloveso - používejte přítomný čas, 3. osoba jednotného čísla |  |  |  |  | ✅ Napíši jaký systém je použit, nebo píšu Bez systému. Políčko nenechávám prázdn…
1 | IT system | IT system | Connects parent  and patron forms | Connects the forms from parents and patron | ─ | automatically | automatically | BE | BE | Ke kontrole / to check | To check | yes | yes | yes | yes | yes | yes | yes | yes
2 | Coordinator FRONT | Coordinator | takes over application | acquires lead | ─ | manually | manually | BE | BE | Zpracování žádosti / Application processing | Application processing | no | no | no | no | yes | yes | yes | yes
3 | Coordinator FRONT | Coordinator | checks the application /obligatory info, attachements, full story) | verifies all the information: medical documents,IDs, attachements, details of se… | ─ | manually | manually | BE | BE | Zpracování žádosti / Application processing | Application processing | no | no | no | no | no | no | no | no
4 | Coordinator FRONT | Coordinator | Rejects the application (due to failure to meet the conditions) | Sends the application to out of scope if the request does not meet the donation … | ─ | manually | manually | BE | BE | Out of scope | Out of scope | yes | yes | yes | yes | yes | yes | yes | yes
5 | Coordinator FRONT | Coordinator | Returns the request for completion | ─ | ─ | manually | ── | BE | ─ | Čeká na doplnění /waiting to be completed | ─ | yes | ── | no | ── | yes | ─ | yes | ─
...
9 | parent | parent | Completes the application | inputs all the necessary information | ─ | manually | manually | BE | BE | Žádost doplněna uživatelem /Application completed by parent | Application completed by parent | yes | yes | no | no | yes | yes | yes | yes
10 | Coordinator FRONT | Coordinator | Checks that the application is complete | verifies if all the information is completed and change the status to "'Suspende… | ─ | manually | manually | BE | BE | Žádost doplněna uživatelem /Application completed by parent | Request on hold | no | no | no | no | no | no | no | no
11 | Coordinator FRONT | Acquisition specialist | Contacts the supplier of the donation, donation request | verifies the donation type, identifies and contacts the relevant supplier | ─ | manually | manually | email/call | BE/call/email |  | Request on hold |  | no |  | no |  | no |  | no
12 | Supplier | Supplier | provides a price quote, confirms cooperation, terms and conditions | comes back with and agrees to the price offer | ─ | manually | manually | email | email/whatsapp message |  | Request on hold |  | no |  | no |  | no |  | no
13 | Coordinator FRONT | Acquisition specialist | sends the request for approval to risk dpt. | sends the application for assessment to the risk manager |  | manually | manually | BE | BE | Scoring kontrola / Scoring control | Scoring | no | no | no | no | yes | no | yes | no
...
30 | Risk manager | Risk manager | rejects the application | rejects the granting of aid if it identifies inconsistencies between the data de… | ─ | manually | manually | BE | BE | Scoring KO | Scoring KO | yes | yes | yes | yes | yes | yes | yes | yes
31 | Risk manager | Risk manager | approves the application | check all data related to the applicant, guarantor, child, gift and supplier | ─ | manually | manually | BE | BE | Scoring OK | Scoring OK | no | no | no | no | yes | yes | yes | yes
32 | Coordinator FRONT | Risk manager | provides a final check of the application and sends to content for preparation o… | After all aspects are verified, the case is approved and the story is requested … | ─ | manually | manually | BE | BE | Příprava příběhu / story preparation | story preparation | yes | yes | no | no | yes | yes | yes | yes
