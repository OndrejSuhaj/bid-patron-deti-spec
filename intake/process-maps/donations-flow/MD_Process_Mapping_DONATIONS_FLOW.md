...
Field | Fill In | RO | MD
Process Name | DONATIONS / FLOW | Donations/ Flow | DONATIONS / FLOW
Country / Team | CZ | RO | MD
Process Owner | Svatava Poulson | Maria Nasco | Madalina Fortuna
Date | 2026-02-13 00:00:00
Process Goal (What is the output?) | MAPPING THE DONATION PROCESS AND ITS PROCESSING IN THE SYSTEM | Knowing the exact flow of the money, from donation to money distribution for cas… | Ensures accurate processing and tracking of donations.
Process Start (What triggers it?) | START OF DONATING BY THE DONOR | The donor initiating any kind of payment | Donation is initiated by the donor.
Process End (When is it finished?) | DONATION ADDED TO THE STORY | Donation is distributed to the story | Donation is completed, recorded, and archived.
...
Role Name | RO | Description (optional) | MD
✅ KDOKOLI NEBO COKOLI KDO VYKONÁVÁ AKCI V PROCESU ( NEPÍŠEME JMÉNA OSOB, ALE JEJ…
To znamená, že to může být
👤 osoba - KOORDINÁTOR
👥 funkce / pozice - ŘEDITEL
...
🏢 externí subjekt
  ...
  ·
Donor | Donor |  | Donor
IT system | IT system | BE | IT system
Notification | Notification | BE+Mautic
Operations manager | Operations manager |  | Operations manager
payment gateway operator | Payment gateway | Comgate | MAIB gateway
Fórum dárců | ---- | organization managing donor's SMS (DMS) | -
recipient | ---- | person who received a gift voucher (dobrošek) from the donor | -
INFO coordinator | ---- |  | Coordionator
KAM Donors | Corporate donors | employee responsible for corporate donore | Operations manager
...
Step Process Number | RO | MD | Role Responsible | RO | MD | Step Description (Start with a verb) | RO | MD | Manual / Automated | RO | MD | System Used (if any) | RO | MD | Status platby | RO | MD | Notifikace email  dárce | RO | MD | Zobrazení v zóně dárce | RO
  ·
 |  |  | ✅ vyberu z listu ROLE |  |  | ✅ Napíši aktivní sloveso - používejte přítomný čas, 3. osoba jednotného čísla |  |  |  |  |  | ✅ Napíši jaký systém je použit, nebo píšu Bez systému. Políčko nenechávám prázdn…
1 | 1 | 1 | donator | donor | donor | create a donation | makes a donation | create a donation | manually | manually | manually | web |  | web |  |  |  | 2 |  |  | dárce
1a | 1a | 1a | donator | donor | donor | makes a donation to support a specific child's story | donates to a chosen story | makes a donation to support a specific child's story | manually | manually | manually | web/Comgate | web/Netopia | web |  |  |  | 1a |  |  | dárce
1b | 1b | 1b | donator | donor | donor | makes a donation to the donation account /former transparent account/ | donates into the  general accoubt | makes a donation to the general account | manually | manually | manually | web/Comgate | web/Netopia | web |  |  |  | 1b |  |  | dárce
1c | 1c | 1c | donator | donor | donor | makes a bank transfer through their bank to our donation account | donates through the bank account | makes a bank transfer through their bank to our donation account | manually | manually | manually | web/banka | web/bank | web |  |  |  | 1c |  |  | dárce
...
1aa | 1aa | 1aa | donator | donor | donor | Enters mandatory data and completes the donation | enters the peyment popup on the specific story and completes all requiered data | completes the required data | manually | manually | manually | Web/comgate | web/Netopia | web | PAID | PAID | COMPLETED | yes | yes | yes | yes | yes
1ab | 1ab | 1ab | Comgate | Netopia | MAIB gateway | confirms donation | vallidates the donation | confirms the donation | automatically | automatically | automatically | BE/Comgate | web/Netopia | Gateway | PAID | PAID | COMPLETED
...
1ad | 1ad | 1ad | bank | Netopia | bank | confirms receiving of donation via API to BE | Confirms payment to FE/BE | confirms the donation | automatically | automatically | automatically | bank/BE | Netopia integration/BE | bank | PAID | PAID | COMPLETED
1ae | 1ae | 1ae | donator | donor | donor | Enters mandatory data and does not finish the donation | Does not go through with donation | does not finish the donation | manually | manually | manually | BE/Comgate | Netopia/BE | web | PENDING | PENDING | FAILED | yes | no | no | no | no
...
collection account via Comgate | general accountaccount via Netopia | General account
1ba | 1ba | 1ba | donator | donor | donor | Enters mandatory data and completes the donation | enters the peyment popup on the specific story and completes all requiered data | completes the required data | manually | manually | manually | BE/Comgate | web/Netopia | web | PAID | PAID | COMPLETED | yes |  | yes | no
1bb | 1bb | 1bb | Comgate |  | MAIB gateway | confirms donation | vallidates the donation | confirms the donation |  | automatically | automatically |  | web/Netopia | Gateway |  | PAID | COMPLETED
...
1bd | 1bd | 1bd | bank |  | bank | confirms receiving of donation via API to BE | Confirms payment to FE/BE | confirms the donation |  | automatically |  |  | Netopia integration/BE |  |  | PAID
1be | 1be | 1be | donator |  | donor | Enters mandatory data and does not finish the donation | Does not go through with donation | does not finish the donation | manually | manually | manually | BE/Comgate | Netopia/BE | Gateway | PENDING | PENDING | FAILED | yes |  | no | no
...
1ca | 1ca |  | IT system |  |  | Transfers the donation to the collection account | Transferes funds to general account |  | automatically | manually |  | bank/BE | bank/BE |  | PAID | PAID
...
1cd | 1cd | 1cd | operational manager | Operatinal manager | operational manager | tranferst donation from collection acount to a specific story | Allocates money to a specific story | Allocates money to a specific story | manually | manually | manually | BE | BE | BE | PAID | PAID |  | no | no |  | yes | yes
DMS | tax reddirection -  individuals | tax reddirection individuals
1da | 1da | 1da | Forum darcu | donor | donor | Sends a monthly sum of donation to the collection account | completes the 230 form | completes the specific forms and the money are redirected to Foundation's acc | manually |  |  |  | FE/paper/email |  | PAID |  |  | X |  |  | X
